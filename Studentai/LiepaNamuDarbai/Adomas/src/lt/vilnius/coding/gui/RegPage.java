...
public class RegPage extends javax.swing.JFrame {
     ...
     */
    public RegPage() throws SQLException, ClassNotFoundException {
        initComponents();
    ...
    private void registerButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerButtonActionPerformed
        if (!usernameInput.getText().equals("")
            ...
            try {
                if (userNotExist()) {
                    logedIN.db.stmt.executeUpdate("INSERT INTO users (username, password) "
                            + "VALUES ('" + usernameInput.getText() + "', "
                            + "'" + passwordInput.getText() + "')");
                    logedIN.db.stmt.executeUpdate("INSERT INTO user_data (first_name, last_name, age, gender) "
                            + "VALUES ("
    ...
    private boolean userNotExist() throws SQLException {
        ResultSet rs = logedIN.db.stmt.executeQuery("SELECT username FROM users WHERE username='" + usernameInput.getText() + "'");
        rs.next();
        try {
